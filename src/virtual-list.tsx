...
import { EVENT_TYPE, SLOT_TYPE, DataSource, Range, SCROLL_DIRECTION } from './types';

// interface ItemProps1 {
//   [key: string]: any;
          ...
          if (typeof uniqueKey === 'string' || typeof uniqueKey === 'number') {
            slots.push(
              <Item
                ...
                component={dataComponent as VueComponent | ((props: any) => JSX.Element) | null}
