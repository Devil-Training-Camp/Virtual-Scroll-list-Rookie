...
var Virtual = /*#__PURE__*/function () {
  ...
  function Virtual(param, callUpdate) {
    ...
    _defineProperty(this, "callUpdate", function () {});
    ...
    _defineProperty(this, "firstRangeTotalSize", 0);

    _defineProperty(this, "firstRangeAverageSize", 0);

    _defineProperty(this, "lastCalcIndex", 0);

    _defineProperty(this, "fixedSizeValue", 0);

    _defineProperty(this, "calcType", '');
...
}; // type a = ExtractPropTypes<typeof b>
  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      ...
      return createVNode(Tag, {
        ...
        "default": function _default() {
          return [Comp && createVNode(Comp, _objectSpread2(_objectSpread2({}, mergedProps), {}, {
...
var VirtualList = defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var getUniqueIdFromDataSources = function getUniqueIdFromDataSources() {
      ...
      return dataSources.map(function (dataSource) {
        ...
        if (typeof dataKey === 'function') {
          ...
          return dataSource[dataKey]; // 使用非空断言运算符确保 dataKey 存在
        }
      });
    };
    ...
    return function () {
      ...
      var _ref3 = range.value,
          padFront = _ref3.padFront,
          padBehind = _ref3.padBehind;
      var paddingStyle = {
